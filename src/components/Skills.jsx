    ...
    <div name='skills' className='w-full h-full'>
      ...
      {/* Skills */}
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center items-center w-full h-full'>
          ...
          <h1 className= 'text-7xl md:text-8xl font-bold text-white text-center mt-16 md:mt-44'>Skills</h1>
          <h2 className='text-white mt-20 text-4xl lg:text-6xl font-semibold text-center'>Programming Languages</h2>
          ...
          <h2 className='text-white mt-20 text-4xl lg:text-6xl font-semibold text-center'>Software</h2>
          <div className='w-full flex flex-wrap gap-10 items-center justify-center mt-10'>
